...
function Button({
  ...
  return (
    <ButtonPrimitive
      data-slot="button"
      // `render` almost always swaps in a Link (an <a>), not a <button> —
      // default nativeButton to false in that case to avoid Base UI's a11y
      // warning, while still allowing an explicit override.
