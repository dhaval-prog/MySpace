 ...
 *
 * showForm=false (the login page's guestExpired-redirect case, with no
 * invite link involved) keeps rendering this component — so the expired
 * dialog can still open — while hiding the toggle button/form itself, since
 * retrying guest sign-in there would just hit the same 7-day refusal again.
 */
export function GuestSignIn({
  ...
  return (
    <div className={showForm ? "mt-4 border-t pt-4" : undefined}>
      {showForm && (
        <>
