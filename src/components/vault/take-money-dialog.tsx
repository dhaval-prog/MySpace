 ...
 * opening a modal — see AddMoneyDialog for the shared rationale.
...
export function TakeMoneyDialog({
  ...
  return (
    <>
      ...
      <div
        className="grid w-full basis-full transition-[grid-template-rows] duration-300 ease-out motion-reduce:transition-none"
